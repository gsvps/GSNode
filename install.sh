...
# Usage: curl -fsSL https://dl.gsvps.com/install.sh?v=0.1.28 | sh
set -eu

VERSION="${GSNODE_VERSION:-0.1.28}"
...
手动清理:
  ...
  curl -fsSL https://cdn.jsdelivr.net/gh/gsvps/GSNode@main/cleanup.sh | sh
EOF
  exit 0
fi
