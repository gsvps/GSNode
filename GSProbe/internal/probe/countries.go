...
// CountryCodeToCN maps ISO 3166-1 alpha-2 codes to Chinese country/region names.
var CountryCodeToCN = map[string]string{
	...
	"VN": "越南", "VU": "瓦努阿图", "WF": "瓦利斯和富图纳", "WS": "萨摩亚", "XK": "科索沃",
